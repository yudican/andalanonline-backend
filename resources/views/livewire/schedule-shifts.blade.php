<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>schedule shifts</span>
                        </a>
        ...
        <div class="col-md-12">
            <livewire:table.schedule-shift-table params="{{$route_name}}" />
        </div>
            ...
            <div class="modal-dialog" permission="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">{{$update_mode ? 'Update' : 'Tambah'}} schedule shifts</h5>
                    </div>
                    <div class="modal-body">
                        <x-select name="shift_id" label="Shift">
                            <option value="">Select Shift</option>
                            @foreach ($shifts as $shift)
                            <option value="{{$shift->id}}">{{$shift->nama_shift}}</option>
                            @endforeach
                        </x-select>
                        <x-select name="schedule_type" label="Schedule Type">
                        ...
                        <x-text-field type="time" name="schedule_time" label="Schedule Time" />
                    </div>
